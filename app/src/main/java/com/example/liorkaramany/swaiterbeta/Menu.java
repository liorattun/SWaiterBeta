...
public class Menu extends AppCompatActivity implements View.OnCreateContextMenuListener, AdapterView.OnItemClickListener {
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (choice)
        {
            case 1: id = mainList.get(index).getId(); url = mainList.get(index).getUrl(); break;
            case 2: id = dessertsList.get(index).getId(); url = dessertsList.get(index).getUrl(); break;
            case 3: id = drinksList.get(index).getId(); url = drinksList.get(index).getUrl(); break;
        }
    ...
    public void deleteDish(String id)
    {
        ...
        switch (choice)
        {
            case 1: dr = FirebaseDatabase.getInstance().getReference("dishes").child("main").child(id);
                dr.removeValue(); break;
            case 2: dr = FirebaseDatabase.getInstance().getReference("dishes").child("desserts").child(id);
                dr.removeValue(); break;
            case 3: dr = FirebaseDatabase.getInstance().getReference("dishes").child("drinks").child(id);
                dr.removeValue(); break;
        }
    ...
    public void editDish(int index)
    {
        ...
        switch (choice)
        {
            case 1: d = mainList.get(index); break;
            case 2: d = dessertsList.get(index); break;
            case 3: d = drinksList.get(index); break;
        }
    ...
    public void orders(View view) {
        Intent t=new Intent(this, Orders.class);
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
        ...
        switch (choice)
        {
            case 1: dish = mainList.get(position); break;
            case 2: dish = dessertsList.get(position); break;
            case 3: dish = drinksList.get(position); break;
        }
        dishes.add(dish);
